...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    'en': {
        ...
        'setup_btn':          'Setup Now',
        # first-run wizard
        'first_run_title':    'LNDIVC Setup Wizard',
        'language_select':    'Select Language',
        'finish_setup':       'Finish & Start',
        # uninstall
        'uninstall':          'Uninstall...',
        ...
        'remove_venv':        'LNDIVC folder — delete manually after closing the app',
